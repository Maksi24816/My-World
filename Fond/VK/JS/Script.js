...
$(document).ready(function() {
	$('.NowsSTopRightBox,.NowsSTopRightBoxWindos').hover(function(event) {
		$('.NowsSTopRightBoxWindos').toggleClass('Act');
	});
});
...
$(document).ready(function() {
	$('.NowsSMidBottonBox').click(function(event) {
...
$(document).ready(function() {
	$('.LikeBox').click(function(event) {
		$('.LikeBox,.Like,.Like2,.LikeBoxText,.Coment,.Posul').toggleClass('Act');
	});
});